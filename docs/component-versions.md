...
- **Past beta gate:** `rich-card` only — v0.4.0, status `beta`.
- **v0.2.x (feature-evolved):** `article-body-01`, `kanban-board-01`.
- **v0.1.1 (patch shipped):** `post-card-01`, `engagement-bar-01`, `media-carousel-01`.
- **All other 30 components** sit at the initial v0.1.0 ship.
...
| `registration-card-01`  | Registration Card 01       | 0.1.0   | alpha  |
...
| `page-hero-news-01`    | Page Hero (News 01) | 0.1.0   | alpha  |
...
| Slug                | Name              | Version | Status |
|---------------------|-------------------|---------|--------|
| `media-carousel-01` | Media Carousel 01 | 0.1.1   | alpha  |
| `story-viewer-01`   | Story Viewer 01   | 0.1.0   | alpha  |
| `video-player-01`   | Video Player 01   | 0.1.0   | alpha  |

## feedback (1)

| Slug           | Name         | Version | Status |
|----------------|--------------|---------|--------|
| `detail-panel` | Detail Panel | 0.1.0   | alpha  |
