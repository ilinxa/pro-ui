# category-cloud — procomp plan

> Stage 2: how. The implementation contract.
>
> See [description](./category-cloud-procomp-description.md) and [analysis](../../migrations/category-cloud/analysis.md).
...
```
src/registry/components/forms/category-cloud/
├── category-cloud.tsx     # 1
├── parts/
│   └── category-chip.tsx     # 2
├── types.ts                  # 3
├── dummy-data.ts             # 4
