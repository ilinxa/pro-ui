# article-meta — consumer guide

> Stage 3: how to use it.
>
> Component lives at [`src/registry/components/data/article-meta/`](../../../src/registry/components/data/article-meta/).
...
The `@ilinxa/article-meta-fixtures` sibling adds the demo dummy-data file. Skip if you have your own data.
...
- Tag chips — reach for `category-cloud`
...
Extracted from `kas-social-front-v0` (`src/app/(platform)/news/[id]/page.tsx`, lines 89–106). The kasder source has the strip inline with hardcoded fields + Turkish strings; this version is data-driven, polymorphic, English-default. See [`docs/migrations/article-meta/analysis.md`](../../migrations/article-meta/analysis.md) for the full extraction notes.
