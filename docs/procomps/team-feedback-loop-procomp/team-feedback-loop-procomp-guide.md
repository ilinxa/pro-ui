# team-feedback-loop — consumer guide

> Stage 3: how to use it. Companion to the [description](./team-feedback-loop-procomp-description.md) (GATE 1) and [plan](./team-feedback-loop-procomp-plan.md) (GATE 2). Shipped v0.1.0, 2026-07-01. Third component of the [`gamification-system`](../../systems/gamification-system/gamification-system-description.md).
...
- **A persistent badge gallery** → that's `team-trophy-shelf` (E2).
...
```tsx
import { TeamFeedbackLoop, type TeamFeedbackLoopHandle } from "@/components/team-feedback-loop"
...
If you also use `team-trophy-shelf`, route each event kind to **exactly one** celebrator:
...
```tsx
import { TeamFeedbackLoopRoot, TeamFeedbackNudge } from "@/components/team-feedback-loop"
...
# fixtures (sample events): add @ilinxa/team-feedback-loop-fixtures
```
