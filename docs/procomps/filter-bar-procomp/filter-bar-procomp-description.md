# filter-bar — procomp description

> Stage 1.
>
> **Migration origin:** [`docs/migrations/filter-bar/`](../../migrations/filter-bar/).
...
```tsx
<FilterBar categories={categories} hideDateRange onChange={setFilters} />
```
