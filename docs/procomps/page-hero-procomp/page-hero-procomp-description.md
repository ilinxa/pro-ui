# page-hero — procomp description

> Stage 1.
>
> **Migration origin:** [`docs/migrations/page-hero/`](../../migrations/page-hero/). Engine: kasder `commons/PageHero.tsx`. Defaults/demo: kasder `news/NewsHero.tsx`.

## Problem

Marketing / content / docs sites need a top-of-page hero band: gradient bg, accent badge chip, large title with optional highlight subline, description, and a flexible content slot for stats / CTAs / search. Pro-ui has zero `marketing` category components beyond newsletter-signup; no hero band yet. Built ad-hoc per project = visual drift + repeated motion-library setups.
