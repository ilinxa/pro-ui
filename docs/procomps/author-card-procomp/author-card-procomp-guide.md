# author-card — consumer guide

> Stage 3: how to use it. Authored alongside the implementation.
>
> Component lives at [`src/registry/components/marketing/author-card/`](../../../src/registry/components/marketing/author-card/).
...
The `@ilinxa/author-card-fixtures` sibling adds the `dummy-data.ts` file used by the docs-site demo. Skip it if you have your own data.
...
Extracted from `kas-social-front-v0` (`src/app/(platform)/news/[id]/page.tsx`, lines 191–205). The kasder source has the block inline with hardcoded Turkish copy; this version is data-driven, English-default, and polymorphic. See [`docs/migrations/author-card/analysis.md`](../../migrations/author-card/analysis.md) for the full extraction notes.
