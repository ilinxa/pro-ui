...
> Extraction pass for [`docs/migrations/page-hero-news-01/`](./). Filled by the assistant after reading `original/` and `source-notes.md`. Reviewed and signed off by you before the procomp gate begins.
>
