...
> **MOSTLY SUPERSEDED 2026-05-25 (same day).** Resume paths 1 AND 3 both executed and completed: path 1 (push + smoke + close F-01) in commit `3a6f707`; path 3 (v0.1.3 micro-patch closing F-03 via `@internal` JSDoc) in commits `48a503c` + `b262b0c`. **Only path 2 (Phase B v0.2.0) remains open.** The current truth lives in [`STATUS.md`](STATUS.md) (top two banner rows). Rest of this file preserved for context.
>
