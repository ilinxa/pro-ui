...
>
> **Active handoff:** [`.claude/HANDOFF-2026-05-25-workspace-v0.1.2-shipped-locally-phase-b-queued.md`](HANDOFF-2026-05-25-workspace-v0.1.2-shipped-locally-phase-b-queued.md) — fresh-session resume point. Past handoff [`.claude/HANDOFF-2026-05-09-session-pause.md`](HANDOFF-2026-05-09-session-pause.md) (frozen; superseded).
>
...
- [2026-05-25 — workspace v0.2.0 GATE 1 CLOSED](decisions/2026-05-25-workspace-v0.2.0-gate-1-closed.md) — pre-implementation planning gate for the alpha → beta promotion ship. 7 in-scope items, 4 breaking changes, 9 Q-Ps locked (QP-3 reversed during re-validation). Next gate = plan refresh (GATE 2).
- [2026-05-25 — workspace v0.1.3 SHIPPED — F-03 close-out](decisions/2026-05-25-workspace-v0.1.3-f-03-internal-jsdoc.md) — `useResizeKeyboard` `@internal` JSDoc + guide Public-API surface note. Patch-bump GATE 3 exempt. All three v0.1.2 spotcheck follow-ups now resolved.
- [2026-05-24 — workspace v0.1.2 SHIPPED — deep-review close-out](decisions/2026-05-24-workspace-v0.1.2-deep-review-closeout.md) — 12 findings closed (9 code + 3 doc; alpha; all non-breaking). 10-commit chain. v0.2.0 work (imperative API + `stack` kind + touch + undo + multi-edge linked resize + beta promotion) scoped in master Phase B plan.
- [2026-05-23 — rich-sidebar v0.3.0 SHIPPED — "A+ pass"](decisions/2026-05-23-rich-sidebar-v0.3.0-a-plus-pass.md) — 11 review findings closed across 7-commit C1–C7 chain; 1 BREAKING TS-only widening of `NavUserMenuItem.onClick` event arg. Race-fix bonus from re-validation (TOGGLE_MOBILE dispatch + EXTERNAL_SYNC stale-reason reset).
