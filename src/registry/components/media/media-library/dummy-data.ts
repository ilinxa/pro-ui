...
/** Deterministic source-key → stable Unsplash photo map (sorted distinct keys, in order). */
const PHOTO_KEY_TO_UNSPLASH: Record<string, string> = {
  "id/1015": "photo-1506744038136-46273834b3fb",
  "id/1016": "photo-1519389950473-47ba0277781c",
  "id/1019": "photo-1486312338219-ce68d2c6f44d",
};
...
function img(
  ...
  const photo = PHOTO_KEY_TO_UNSPLASH[photoKey] ?? PHOTO_KEY_TO_UNSPLASH["id/1015"];
  return {
    id,
    name,
    type: "file",
    ...
    url: `https://images.unsplash.com/${photo}?w=1600&h=1066&fit=crop&q=80`,
    thumbnailUrl: `https://images.unsplash.com/${photo}?w=600&h=400&fit=crop&q=80`,
  };
}
...
export const MEDIA_LIBRARY_NODES: MediaNode[] = [
  ...
  { id: "f-video", name: "Video", type: "folder", modifiedAt: relativeIso({ days: 8 }), children: undefined },
  {
    ...
    url: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=2400&h=1350&fit=crop&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=640&h=360&fit=crop&q=80",
  },
  {
    id: "file-og",
    name: "og-card.png",
    ...
    url: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&h=630&fit=crop&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=600&h=315&fit=crop&q=80",
  },
  {
    id: "file-favicon",
    name: "favicon.png",
    ...
    url: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=512&h=512&fit=crop&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=256&h=256&fit=crop&q=80",
  },
];
