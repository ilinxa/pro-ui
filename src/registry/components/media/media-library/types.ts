 ...
 * `<FileTree nodes={...}>` boundary (the carousel-composer
...
/**
 * Shared data + handler surface. {@link MediaLibraryProps} adds the chrome
...
export const DEFAULT_MEDIA_LIBRARY_LABELS: Required<MediaLibraryLabels> = {
  title: "Media library",
