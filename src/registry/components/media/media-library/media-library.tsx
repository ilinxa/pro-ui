...
import type { MediaLibraryHandle, MediaLibraryProps } from "./types";
 ...
 */
export const MediaLibrary = forwardRef<MediaLibraryHandle, MediaLibraryProps>(
  function MediaLibrary(props, ref) {
    const {
      showQuota = true,
