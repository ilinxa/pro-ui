...
import type { ComposerMode, StoryComposerLabels } from "../types";
 ...
 * an F-cross-13 carrier that breaks Base-UI consumers (filter-panel 0.1.1 /
 * event-calendar v0.2.1 precedent: same swap). Re-tapping the active mode stays
