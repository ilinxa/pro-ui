...
import type { AspectRatio } from "../media-editor";
...
// AspectRatio moved to media-editor in v0.2.0 (added "16:9" as additive
...
export const DEFAULT_STORY_COMPOSER_LABELS: Required<StoryComposerLabels> = {
