...
export const meta: ComponentMeta = {
  ...
  features: [
    ...
    "v0.2.0 — Engagement overlay composing engagement-bar-01 v0.3.x (variant=stacked) — like + reaction (host-supplied kinds) + comment + share (bookmark removed in v0.3.0; kebab moved to header in v0.3.5; column collapsed-by-default with heart toggle in v0.3.7)",
    "v0.2.0 — DM composer (always-visible bottom 'Reply to @user…' input — Instagram-canonical Direct Message channel, NOT public comments). Composes comment-thread-01 v0.2.1 CommentComposer with auto-pause-on-type. `onAddReply` callback name preserved for back-compat.",
