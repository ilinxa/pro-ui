 ...
 * inside a plain text body. Sub-exported from `post-card/index.ts` per
 ...
 * `<ExpandableText content={post.content}>`, which takes `content: string`
 ...
 * ExpandableText to accept ReactNode children.
 *
