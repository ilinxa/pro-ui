export default function BlackboardUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>Blackboard</code> when a team needs a shared, low-ceremony{" "}
        ...
        <strong>not</strong> a threaded comment list (<code>comment-thread</code>), a chat
        panel, or a freeform whiteboard.
      </p>

      <h3 className="mb-2 mt-6 text-base font-semibold">Basic example</h3>
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { Blackboard } from "@/components/blackboard"
