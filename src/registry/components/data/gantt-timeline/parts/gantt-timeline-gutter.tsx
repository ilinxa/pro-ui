...
/* eslint-disable react-hooks/refs -- gutterTrackRef is bundled on the context value; the
   ...
   blackboard). The ref is used only as a ref= prop + read inside effects. */
...
import type { GanttRow, TaskLabelOption, TaskStatusOption } from "../types";
...
function rowAriaLabel(row: GanttRow, statusOpt?: TaskStatusOption): string {
  const { item } = row;
