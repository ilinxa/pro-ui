...
export const GANTT_STATUS_OPTIONS: TaskStatusOption[] = [
...
export const GANTT_PRIORITY_OPTIONS: TaskPriorityOption[] = [
  { value: "low", label: "Low", color: "var(--muted-foreground)" },
  { value: "high", label: "High", color: "var(--destructive)" },
];

export const GANTT_LABEL_OPTIONS: TaskLabelOption[] = [
...
export const GANTT_DUMMY: TaskItem[] = [
  {
    id: "epic-1",
