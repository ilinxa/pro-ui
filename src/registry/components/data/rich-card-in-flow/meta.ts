...
export const meta: ComponentMeta = {
  ...
  features: [
    ...
    "n8n-style multi-select supported via flow-canvas-01's marquee + shift-click (bulk-edit-via-dialog deferred to v0.2)",
  ...
  dependencies: {
    // Renderer itself uses no shadcn primitives directly — the title-strip
    // and subcard blocks are native <button>+<div>. The consumer-owned
    // dialog (Dialog, Drawer, Sheet, etc.) is the consumer's choice and
    // doesn't get auto-installed via this procomp.
    shadcn: [],
    npm: {},
