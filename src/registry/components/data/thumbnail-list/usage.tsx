export default function ThumbnailListUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2 text-muted-foreground">
        ...
        <code>magazine-layout</code>.
      </p>

      <h3 className="mb-2 mt-6 text-base font-semibold">Basic example</h3>
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { ThumbnailList } from "@/components/thumbnail-list"
...
export function Example() {
  return <ThumbnailList items={items} labels={{ heading: "Related" }} />
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`<ThumbnailList items={searchHits} framed={false} />`}</code>
      </pre>
...
<ThumbnailList items={items} linkComponent={Link} />`}</code>
      </pre>
