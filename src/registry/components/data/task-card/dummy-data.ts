...
export const DEMO_STATUS_OPTIONS: TaskStatusOption[] = [
 ...
 */
export const DEMO_STATUS_OPTIONS_TONED: TaskStatusOption[] = [
  { value: "todo", label: "To do", variant: "outline" },
  { value: "in-progress", label: "In progress", variant: "default" },
...
export const DEMO_PRIORITY_OPTIONS: TaskPriorityOption[] = [
...
export const URGENT_TASK: TaskItem = {
  id: "task-urgent",
...
export const OVERDUE_TASK: TaskItem = {
  id: "task-overdue",
  ...
  targetPerson: {
    id: "amir",
    name: "Amir",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=128&h=128&fit=crop&crop=faces&q=80",
  },
...
export const NESTED_FAMILY: TaskItem = {
  id: "task-nested-root",
...
export const PRIORITIZED_TASK: TaskItem = {
  id: "task-prioritized",
  ...
  targetPerson: { id: "hessam", name: "Hessam", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=128&h=128&fit=crop&crop=faces&q=80" },
};

export const DONE_TASK: TaskItem = {
  id: "task-done",
...
export const BLOCKED_TASK: TaskItem = {
  id: "task-blocked",
