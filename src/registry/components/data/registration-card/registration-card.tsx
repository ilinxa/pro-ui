...
function getCtaConfig(
  ...
  labels: Required<RegistrationCardLabels>,
): {
  label: string;
...
function RegistrationCardInner({
  capacity,
  registered,
  closed = false,
  statusOverride,
  ...
  const labels = useMemo<Required<RegistrationCardLabels>>(
...
const RegistrationCard = memo(RegistrationCardInner);
