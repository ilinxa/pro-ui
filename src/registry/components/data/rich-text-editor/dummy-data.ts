...
export const RICH_TEXT_DUMMY_RICH: RichTextValue = [
  {
    type: "h1",
...
export const RICH_TEXT_DUMMY_SIMPLE: RichTextValue = [
...
export const RICH_TEXT_DUMMY_EMPTY: RichTextValue = [
  { type: "p", children: [{ text: "" }] },
];

export const RICH_TEXT_DUMMY_TABLE: RichTextValue = [
...
export const RICH_TEXT_DUMMY_CODE: RichTextValue = [
...
export const RICH_TEXT_DUMMY_IMAGE: RichTextValue = [
