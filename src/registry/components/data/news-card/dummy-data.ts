 ...
 */
export const breakingNewsItem: NewsCardItem = {
  id: "v3-1",
  ...
  authorEntity: {
    ...
    name: "Ayşe Yılmaz",
    role: "Chief Editor",
    avatar: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=128&h=128&fit=crop&crop=faces&q=80",
    isVerified: true,
  },
  publisher: {
    id: "pub-1",
 ...
 */
export const paywalledItem: NewsCardItem = {
  id: "v3-2",
 ...
 */
export const sensitiveItem: NewsCardItem = {
  id: "v3-3",
 ...
 */
export const draftItem: NewsCardItem = {
  id: "v3-4",
 ...
 */
export const sponsoredItem: NewsCardItem = {
  id: "v3-5",
 ...
 */
export const quotingItem: NewsCardItem = {
  id: "v3-6",
 ...
 */
export const editorsPickItem: NewsCardItem = {
  id: "v3-7",
 ...
 */
export const v3DummyItems: NewsCardItem[] = [
  breakingNewsItem,
  paywalledItem,
  sensitiveItem,
  draftItem,
