 ...
 *
 * **Consumers wanting the full engagement-bar** (inline likers, share menu,
 * realtime subscribe) pass `<EngagementBar>` into the
 ...
 * `NewsCardItem` deliberately matches engagement-bar's counts shape so
 * the slot is drop-in.
 *
