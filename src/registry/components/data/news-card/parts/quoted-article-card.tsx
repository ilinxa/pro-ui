...
import type { NewsCardItem, NewsCardProps } from "../types";
...
export interface QuotedArticleCardProps {
   ...
   */
  onClick?: (quotedArticle: NewsCardItem) => void;
  /** Optional href for the default navigation case. */
  href?: string;
  /** Polymorphic root for the anchor case. Default 'a'. */
  linkComponent?: NewsCardProps["linkComponent"];
  /** Forwarded to the nested `<NewsCard>` for label strings. */
 ...
 *
 * Renders a nested `<NewsCard variant="small">` with the compact
