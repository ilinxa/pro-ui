export default function EventCalendarUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>EventCalendar</code> when you already hold the canonical{" "}
        <code>TaskItem[]</code> (the data behind <code>task-card</code>,{" "}
        <code>task-tree</code>, <code>kanban-board</code>, and{" "}
        <code>gantt-timeline</code>) and want a date-grid surface — month,
