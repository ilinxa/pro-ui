...
export const CALENDAR_STATUS_OPTIONS: TaskStatusOption[] = [
...
export const CALENDAR_PRIORITY_OPTIONS: TaskPriorityOption[] = [
  { value: "low", label: "Low", color: "var(--muted-foreground)" },
  { value: "high", label: "High", color: "var(--destructive)" },
];

export const CALENDAR_LABEL_OPTIONS: TaskLabelOption[] = [
...
/**
 * Builds a varied TaskItem[] anchored to `base` — exercises every visual state:
 ...
 */
export function buildCalendarDummyData(base: Date): TaskItem[] {
  return [
    {
      id: "1",
      name: "Design review",
...
export const CALENDAR_DUMMY: TaskItem[] = buildCalendarDummyData(
  new Date(2026, 5, 15),
);
