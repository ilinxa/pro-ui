export default function StoryRailUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>StoryRail</code> when you need a horizontal stories
        ...
        <code>story-viewer</code>, a navigation push, etc.).
      </p>
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { StoryRail } from "@/components/story-rail";
...
/>`}</code>
      ...
      <p className="text-muted-foreground">
        ...
        <code>engagement-bar</code> / <code>comment-thread</code> /{" "}
        <code>post-card</code>).
      </p>
...
/>`}</code>
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`<StoryRail items={stories} framed={false} className="px-4" />`}</code>
      </pre>
      <p className="text-muted-foreground">
