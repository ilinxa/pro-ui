...
export interface StoryRailProps {
  ...
  /**
   * Click handler — object-shape. Host typically opens a story viewer.
   * v0.2 cutover from positional `(item, index)`.
   */
  onItemClick?: (args: { item: StoryRailItem; index: number }) => void;
