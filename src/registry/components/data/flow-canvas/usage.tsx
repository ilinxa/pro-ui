  ...
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { FlowCanvas, type NodeRenderer } from "@/components/flow-canvas"
...
const sourceShape = exportRef.current?.export({ withPorts: false })`}</code>
      ...
      <p className="mt-6 text-xs text-muted-foreground">
        Full reference: see <code>docs/procomps/flow-canvas-procomp/flow-canvas-procomp-guide.md</code>.
