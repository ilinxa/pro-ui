...
/**
 * Default status enum used by task-tree demos.
 * Consumers pass their own via `statusOptions` prop.
 */
export const TASK_TREE_DEMO_STATUS_OPTIONS: TaskStatusOption[] = [
...
/**
 * Frozen "now" for deterministic demos — pin via `now={TASK_TREE_DEMO_NOW}`
 * in any composed TaskCard to keep snapshots stable.
 */
export const TASK_TREE_DEMO_NOW = new Date("2026-05-20T12:00:00Z");
 ...
 */
export const TASK_TREE_DEMO_ITEMS: TaskItem[] = [
  {
    id: "tt-q3-ship",
    name: "Ship Q3 plan",
    status: "in-progress",
