export default function PricingTableUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>PricingTable</code> for any marketing-page pricing
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { PricingTable } from "@/components/pricing-table";
...
/>;`}</code>
      ...
      <ul className="ml-5 list-disc space-y-1 text-muted-foreground">
        <li>
          ...
          tier ring + badge. Matches <code>newsletter-signup</code>&apos;s primary
          tone.
        </li>
        <li>
