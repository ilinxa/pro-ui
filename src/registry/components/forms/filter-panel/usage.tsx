export default function FilterPanelUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>FilterPanel</code> when you have a list of typed items
...
export function ProjectFilters({ projects }: { projects: Project[] }) {
  ...
  return (
    ...
    />
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`const ref = useRef<FilterPanelHandle>(null);
// ...
