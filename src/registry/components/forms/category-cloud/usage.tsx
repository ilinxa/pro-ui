export default function CategoryCloudUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>CategoryCloud</code> when you have a fixed set of
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { CategoryCloud } from "@/components/category-cloud";

<CategoryCloud items={["All", "Tech", "Design", "Engineering"]} />;`}</code>
      </pre>
