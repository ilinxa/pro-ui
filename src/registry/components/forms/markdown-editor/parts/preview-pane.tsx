...
export function PreviewPane({
  ...
  return (
    <div
      ...
      style={style}
      // Safe sink (v0.1.2): `html` comes from lib/parse-markdown.ts, whose
      // per-instance Marked ESCAPES all raw HTML tokens (block + inline) and
      // scheme-filters link hrefs (javascript:/data:/vbscript: stripped) —
      // untrusted multi-author markdown cannot inject markup here. Wikilink
      // spans are generated by our renderer with escaped label/target.
