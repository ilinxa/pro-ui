...
/**
 * Six fixture shapes covering the canonical signup surfaces.
...
const NOOP_ON_SUBMIT: SignupFormProps["onSubmit"] = () => {
...
export const defaultSignupProps: SignupFormProps = {
...
export const oauthSignupProps: SignupFormProps = {
  heading: "Create your account",
...
export const twoStepSignupProps: SignupFormProps = {
  heading: "Create your account",
...
export const magicLinkSignupProps: SignupFormProps = {
...
export const denseSignupProps: SignupFormProps = {
...
export const controlledSignupProps: SignupFormProps = {
  heading: "Create your account",
  subheading:
