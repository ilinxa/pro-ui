import type { SidebarNav01MobileOpenReason } from "../types";

// ─────────────────────────────────────────────────────────────────────────
// Internal reducer state + actions
// (Internal shape — NOT exported via index.ts. Consumers interact with the
// component via the imperative handle + public SidebarNav01StateValue.)
// ─────────────────────────────────────────────────────────────────────────
...
export type SidebarReducerAction =
  ...
  | { type: "SET_MOBILE_OPEN"; open: boolean; reason: SidebarNav01MobileOpenReason }
  | { type: "TOGGLE_MOBILE" }
