export default function SidebarNav01Usage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      ...
      <p className="text-muted-foreground">
        ...
        out across C2–C13. The full <code>SidebarNav01Props</code> surface is
      ...
      <p className="text-muted-foreground">
        Reach for <code>SidebarNav01</code> for any desktop app shell that
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { SidebarNav01, type NavItem } from "@ilinxa/sidebar-nav-01";
