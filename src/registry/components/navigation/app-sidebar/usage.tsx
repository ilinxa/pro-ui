export default function AppSidebarUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      ...
      <p className="text-muted-foreground">
        ...
        out across C2–C13. The full <code>AppSidebarProps</code> surface is
      ...
      <p className="text-muted-foreground">
        Reach for <code>AppSidebar</code> for any desktop app shell that
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { AppSidebar, type NavItem } from "@ilinxa/app-sidebar";
    ...
    <div className="flex min-h-screen">
      ...
      <ul className="ml-5 mt-2 list-disc space-y-1 text-muted-foreground">
        <li>
          ...
          <code> AccountSwitcher</code> / governance bar / status banner.
        ...
        <li>
          ...
          NOT coupled to <code>&lt;AppSidebar&gt;</code> — render your own
      ...
      <p className="mt-3 text-xs text-muted-foreground">
        Composition recipe — drop <code>&lt;AccountSwitcher&gt;</code> into{" "}
        ...
        dep between app-sidebar and account-switcher.
      </p>
      ...
      <p className="text-muted-foreground">
        <code>app-sidebar</code> is viewport-aware (built-in mobile drawer
        below <code>mobileBreakpoint</code>) AND container-aware via{" "}
        <code>isCollapsed</code> (icon-only desktop mode). The slotted{" "}
        <code>&lt;AccountSwitcher&gt;</code> is NOT viewport-aware on its
...
/>`}</code>
      ...
      <p className="mt-2 text-xs text-muted-foreground">
        ...
        <code>account-switcher-procomp-guide.md</code> §4.6.
      </p>
    </div>
  );
}
