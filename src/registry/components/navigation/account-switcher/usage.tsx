export default function AccountSwitcherUsage() {
  return (
    <div className="prose-sm flex max-w-none flex-col gap-6 text-sm leading-relaxed text-foreground">
      <section>
        <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
        <p className="text-muted-foreground">
          Reach for <code>AccountSwitcher</code> any time the UI needs a &ldquo;current X +
      ...
      <section>
        ...
        <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
          <code>{`import { AccountSwitcher } from "@/components/account-switcher";
...
/>`}</code>
      ...
      <section>
        ...
        <p className="mb-2 text-muted-foreground">
          When slotted into a collapsed icon-only sidebar (e.g., <code>app-sidebar</code>&apos;s
...
/>`}</code>
      ...
      <section>
        ...
        <ul className="ml-5 list-disc space-y-1 text-muted-foreground">
          ...
          <li>
            Sibling: <code>app-sidebar</code> v0.2.0 mounts this primitive in its{" "}
