...
import type { FsNode, FileManagerLabels } from "../types";

interface FileManagerDeleteConfirmProps {
  open: boolean;
  ids: string[];
  nodes: FsNode[];
...
export function FileManagerDeleteConfirm(
  props: FileManagerDeleteConfirmProps,
) {
