...
/**
 * MagazineLayout — slot-based magazine layout. Composes the news-domain
 * components (page-hero / filter-bar / news-cards / category-cloud /
 * newsletter-signup) at the consumer level via slots; the layout itself
 ...
 */
export function MagazineLayout<T>(props: MagazineLayoutProps<T>) {
  const {
    displayedItems,
    featuredItem,
    hasMore = false,
