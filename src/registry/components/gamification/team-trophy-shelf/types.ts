...
/**
 * `team-trophy-shelf` — public type surface.
 *
...
export interface TeamTrophyShelfBaseProps {
   ...
   * `team-feedback-loop` (E6) MUST set this `false` so the moment is not
...
/** Props for the batteries-included `TeamTrophyShelf` assembly. */
export interface TeamTrophyShelfProps extends TeamTrophyShelfBaseProps {
