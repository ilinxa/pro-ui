...
/**
 * `team-challenge` — public type surface.
 *
...
export interface TeamChallengeBaseProps {
...
/** Props for the headless provider `TeamChallengeRoot`. */
export interface TeamChallengeRootProps
  extends TeamChallengeBaseProps {
  children: ReactNode;
  className?: string;
  "aria-label"?: string;
}

/** Props for the batteries-included `TeamChallenge` assembly. */
export interface TeamChallengeProps
  extends TeamChallengeBaseProps {
...
export interface TeamChallengeContextValue {
  challenge: Challenge;
  team: Team;
