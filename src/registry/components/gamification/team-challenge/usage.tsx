export default function TeamChallengeUsage() {
  return (
    <div className="max-w-none text-sm leading-relaxed text-foreground">
      <h3 className="mb-2 mt-0 text-base font-semibold">When to use</h3>
      <p className="text-muted-foreground">
        Reach for <code>TeamChallenge</code> when a team app wants a{" "}
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { TeamChallenge } from "@/components/team-challenge"
...
export function TeamChallengeZone({ challenge, team }) {
  return (
    ...
    />
      ...
      <pre className="overflow-x-auto rounded-md border border-border bg-muted p-4 font-mono text-xs">
        <code>{`import { OptInToggle, TeamMemberStack } from "@/components/team-challenge"
...
<TeamMemberStack members={team.members} />`}</code>
      ...
      <ul className="ml-5 list-disc space-y-1 text-muted-foreground">
        ...
        <li>
          ...
          celebration overlay is <code>team-feedback-loop</code> (E6) — compose
