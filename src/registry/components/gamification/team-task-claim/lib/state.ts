import type { TaskClaimRenderState, TaskClaimState } from "../types";
 ...
 * `TeamTaskClaim` assembly — a kit-extraction candidate (system §7.3).
 */
export function resolveTaskClaimState(
  v: TaskClaimState,
