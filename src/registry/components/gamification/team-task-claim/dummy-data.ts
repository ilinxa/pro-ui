import type { TaskClaimState, TeamMember } from "./types";

/**
 * Fixtures for `team-task-claim` — one team's `members` + `TaskClaimState`
...
export const CHOICE_OPEN: TaskClaimState = {
  taskId: "T-open",
  openForAnyone: true,
...
export const CHOICE_CLAIMED: TaskClaimState = {
  taskId: "T-claimed",
  openForAnyone: false,
  assigneeId: "u-theo",
};
...
export const CHOICE_UNASSIGNED: TaskClaimState = {
  taskId: "T-unassigned",
  openForAnyone: false,
  assigneeId: undefined,
};
...
export const CHOICE_ASSIGNED_AND_OPEN: TaskClaimState = {
  taskId: "T-edge",
  openForAnyone: true,
  assigneeId: "u-ama",
};
...
export const CHOICE_STALE_ASSIGNEE: TaskClaimState = {
  taskId: "T-stale",
  openForAnyone: false,
  assigneeId: "u-ghost",
};
