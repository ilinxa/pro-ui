...
/**
 * `team-progress-bar` — public type surface.
 *
...
/** Props for the batteries-included `TeamProgressBar` assembly. */
export interface TeamProgressBarProps extends TeamProgressBarBaseProps {
