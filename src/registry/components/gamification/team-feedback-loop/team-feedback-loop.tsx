...
import type { TeamFeedbackLoopProps, TeamFeedbackLoopHandle } from "./types";
 ...
 */
export const TeamFeedbackLoop = React.forwardRef<
  TeamFeedbackLoopHandle,
  TeamFeedbackLoopProps
>(function TeamFeedbackLoop(
