...
/**
 * `team-feedback-loop` — public type surface.
 *
...
/** Props for the batteries-included `TeamFeedbackLoop` assembly. */
export interface TeamFeedbackLoopProps extends TeamFeedbackLoopBaseProps {
